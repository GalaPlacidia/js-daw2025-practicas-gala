...
function cargarPantalla3() {
  document.getElementById('boton').addEventListener('click', function () {
    ...
    let verdad = document.getElementById('t');
    ...
    if (puntuacion < 0 || puntuacion >= 10 || puntuacion != typeof Number) {
    ...
    if (verdad.disabled == false) {
      setCookie('verdaderoFalso', verdad);
    } else {
      setCookie('verdaderoFalso', falso);
    }
